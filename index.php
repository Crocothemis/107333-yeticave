...
$time_remaining_ts = ($tomorrow - $now);
$lot_time_remaining = date("H:i", $time_remaining_ts);

$categories = ["Доски и лыжи", "Крепления", "Ботинки", "Одежда", "Инструменты", "Разное"];

$lots = [["title" => "2014 Rossignol District Snowboard", "category" =>"Доски и лыжи", "price"=>"10999", "image"=> "img/lot-1.jpg"],
         ["title" => "DC Ply Mens 2016/2017 Snowboard", "category" =>"Доски и лыжи", "price"=>"159999", "image"=> "img/lot-2.jpg"],
        ...
        <div class="lots__header">
            ...
            <select class="lots__select">
                ...
                <?php
                    ...
                    while ($cat_index < $num) {
                        $categories_item = $categories[$cat_index];
                        print "<option>" . $categories_item . "</option>";
                        $cat_index++;
                    }
                ?>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?php print($lots_item["image"]);?>" width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"> <?php print($lots_item["category"]);?></span>
                    <h3 class="lot__title"><a class="text-link" href=""> <?php print($lots_item["title"]);?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?php print($lots_item["price"]);?><b class="rub">р</b></span>
                        </div>
